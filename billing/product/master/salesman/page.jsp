...
<head>
    <meta charset="UTF-8">
    <title>Salesman - Billing App</title>
...
<% } %>
    ...
    <div class="container mt-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<%=contextPath%>/product/master/salesman/page1.jsp" method="post" class="row g-3">
                    <div class="col-md-8 input-outline">
                        <input type="text" name="salesmanName" class="form-control" placeholder="" required>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0;">
                    ...
                    <tbody>
                        <%
                            Vector vec = prod.getSalesmanList();
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
                            ...
                            <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem;">
                                <a href="<%=contextPath%>/product/master/salesman/edit.jsp?id=<%=id%>&name=<%=name%>&isActive=<%=isActive%>" class="btn btn-warning btn-sm">Edit</a>
                                <% if (isActive == 1) { %>
                                    <a href="<%=contextPath%>/product/master/salesman/block.jsp?id=<%=id%>&action=block" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to block this salesman?')">Block</a>
                                <% } else { %>
                                    <a href="<%=contextPath%>/product/master/salesman/block.jsp?id=<%=id%>&action=unblock" class="btn btn-success btn-sm" onclick="return confirm('Are you sure you want to unblock this salesman?')">Unblock</a>
                                <% } %>
                            </td>
                        </tr>
                        <%
