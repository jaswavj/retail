...
<% } %>
                ...
                <table class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0;">
                    ...
                    <tbody>
                        ...
                        <%
                            ...
                            out.println("<tr><td colspan='3' class='text-center text-danger'>Error loading brands: " + e.getMessage() + "</td></tr>");
                            e.printStackTrace();
                        }
                        %>
                    </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 8px; border: none; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.15);">
                ...
                <div class="modal-body" style="padding: 1.25rem;">
                    <form id="editForm" action="<%=contextPath%>/product/master/brands/editBrands1.jsp" method="post">
                        ...
                        <div class="mb-2">
                            <div class="form-check" style="padding: 8px; background: #fff5f5; border-radius: 6px; border-left: 3px solid #f56565;">
                                ...
                                <label class="form-check-label" for="editBlock" style="color: #c53030; font-weight: 500; font-size: 0.85rem;">
                                    <i class="fas fa-exclamation-triangle me-1"></i>Block this <%=head2.toLowerCase()%>
                                </label>
                            </div>
                            <small class="text-muted" style="display: block; margin-top: 4px; font-size: 0.75rem;">Blocking will make this brand unavailable for selection</small>
                        </div>
    ...
    <script>
        function openEditModal(brandsName, brandsId) {
            document.getElementById('currentName').value = brandsName;
            document.getElementById('editBrandsName').value = brandsName;
            document.getElementById('editBrandsId').value = brandsId;
            ...
            setTimeout(() => {
                document.getElementById('editBrandsName').focus();
            }, 500);
        }
    </script>
