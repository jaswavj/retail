...
<%
    request.setAttribute("pageTitle",    "Sales by " + head3);
    request.setAttribute("pageSubtitle", "Reports — Item Sales");
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2 no-print">
        <a href="<%=contextPath%>/reports/salesByItem/page.jsp" class="bb bb-outline"><i class="fa-solid fa-arrow-left me-1"></i>Back</a>
        <button class="bb bb-navy" onclick="printReport()"><i class="fa-solid fa-print me-1"></i>Print</button>
        <button class="bb bb-green" onclick="exportTableToExcel('printTable', 'Sales_By_Item_Report')"><i class="fa-solid fa-file-excel me-1"></i>Export</button>
    </div>
</div>
